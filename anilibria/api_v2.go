...
func (m *ApiClient) getApiResponseV2(hmethod string, amethod ApiRequestMethod, params ...interface{}) (arsp *apiResponse) {
	arsp = &apiResponse{}
	...
	if arsp.err = m.checkApiAuthorization(&rrl); arsp.Err() != nil {
		return
	}
